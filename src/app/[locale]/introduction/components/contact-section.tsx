...
export default function ContactSection() {
  ...
  return (
    <div
      id='contact'
      className='relative flex flex-col items-center justify-center min-h-[60vh] w-full py-20'
    >
      <div className='relative z-10 w-full max-w-3xl px-4'>
        <div className='relative bg-white/60 backdrop-blur-xl border border-white/50 rounded-3xl p-8 md:p-12 text-center transform transition-all hover:scale-[1.01] duration-500 overflow-hidden'>
          {/* Decorative Background Elements */}
          <div className='absolute top-[-20%] left-[-10%] w-[400px] h-[400px] bg-blue-200/50 rounded-full blur-[80px]' />
          <div className='absolute bottom-[-20%] right-[-10%] w-[300px] h-[300px] bg-purple-200/50 rounded-full blur-[80px]' />
