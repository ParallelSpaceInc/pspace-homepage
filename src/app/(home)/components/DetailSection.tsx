import svgPaths from '../../../imports/svg-vqx8tdhbfd';
...
function Group() {
  return (
    <div className='[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative'>
      <div
        className='[grid-area:1_/_1] h-[387px] ml-0 mt-0 relative w-[540px]'
        data-name='스크린샷 2025-02-25 14120451 1'
      >
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
          <img
            alt=''
            className='absolute h-[121.95%] left-0 max-w-none top-0 w-full'
            src={img20250225141204511.src}
          />
        </div>
      </div>
...
function Group1() {
  return (
    <div className='grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full'>
      <Group />
      <div
        className='[grid-area:1_/_1] h-[48.124px] ml-[233.35px] mt-[169.44px] relative w-[76.84px]'
        data-name='Vector'
      >
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  mode='normal'
                  result='effect1_dropShadow_1_1935'
                />
                <feBlend
                  in='SourceGraphic'
                  in2='effect1_dropShadow_1_1935'
                  mode='normal'
                  result='shape'
                />
              </filter>
...
function Component() {
  return (
    <div
      className='box-border content-stretch flex flex-col gap-[32px] h-[458px] items-center justify-center max-h-[458px] max-w-[640px] min-h-[281.241px] min-w-[393px] px-[50px] py-0 relative shrink-0 w-[640px]'
      data-name='1'
    >
      <Group1 />
    </div>
...
function Component1() {
  return (
    <div
      className='content-stretch flex flex-col gap-[32px] h-[458px] items-center justify-center max-h-[458px] max-w-[640px] min-h-[281.241px] min-w-[393px] relative shrink-0 w-[640px]'
      data-name='2'
    >
      <Frame />
    </div>
...
function Component3() {
  return (
    <div
      className='box-border content-stretch flex flex-col h-[458px] items-center justify-center max-h-[458px] max-w-[640px] min-h-[281.241px] min-w-[393px] px-[50px] py-0 relative shrink-0 w-[640px]'
      data-name='4'
    >
...
function Component4() {
  return (
    ...
    >
      <div
        className='aspect-[473/458] basis-0 grow min-h-px min-w-px relative shrink-0'
        data-name='dsd0 1'
      >
        <img
          alt=''
...
function Frame10() {
  return (
    <div className='bg-[#f26969] content-stretch flex flex-col gap-[32px] h-[458px] items-start justify-center shrink-0 w-[640px]' />
  );
}
  ...
  return (
    <div className='content-stretch flex flex-col gap-[48px] items-start leading-[0] not-italic relative shrink-0 w-[400px]'>
      ...
      <div className='flex flex-col font-light justify-center relative shrink-0 text-[#333d4b] text-[18px] text-nowrap'>
        <p className='leading-[27px] whitespace-pre'>{t('detail.texture.desc')}</p>
      </div>
    </div>
  );
}
...
export default function DetailSection() {
  return (
    <section className='detail-section bg-gray-50 relative size-full py-20 px-4'>
      <div className='flex flex-row justify-center size-full'>
        <div className='box-border content-start flex flex-wrap gap-8 items-start justify-center relative size-full max-w-[1280px]'>
          <Component />
          <Component1 />
          <Component2 />
          <Component3 />
