      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <h2 className="text-white text-xl font-bold tracking-tight">{t('footer.companyName')}</h2>
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <span className="text-xs border-b border-gray-600 pb-0.5 hover:border-white">{t('footer.terms')}</span>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <span className="text-xs border-b border-gray-600 pb-0.5 hover:border-white">{t('footer.privacy')}</span>
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col gap-6">
            ...
            <div className="pt-4">
              <div className="flex gap-4">
                <a href="#" className="size-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 hover:text-white transition-all" aria-label="LinkedIn">
                  <Linkedin size={18} />
                </a>
                <a href="#" className="size-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 hover:text-white transition-all" aria-label="Naver Blog">
                  <MessageCircle size={18} />
                </a>
                <a href="#" className="size-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 hover:text-white transition-all" aria-label="Youtube">
                  <Youtube size={18} />
                </a>
              </div>
            </div>
