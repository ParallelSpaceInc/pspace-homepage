...
function Frame1() {
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start leading-[0] not-italic relative shrink-0 text-nowrap">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center relative shrink-0 text-[#191f28] text-[48px]">
        <p className="leading-[1.45] text-nowrap whitespace-pre">{t('bimViewer.title')}</p>
      </div>
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center leading-[1.55] relative shrink-0 text-[#6b7684] text-[22px] whitespace-pre">
...
function Frame3() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10px] grow items-center justify-center min-h-px min-w-[330px] relative shrink-0">
      <div className="aspect-[1440/1080] relative shrink-0 w-full" data-name="제목 없는 동영상 (3) 1">
        <video autoPlay className="absolute max-w-none object-cover size-full" controlsList="nodownload" loop playsInline>
          <source src="/_videos/v1/b9ab98f1de68f3463465a8e4f25864ef57b44f41" />
        </video>
      </div>
    </div>
  );
