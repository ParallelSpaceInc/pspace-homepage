...
function Frame1() {
  ...
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-center leading-[0] not-italic relative shrink-0 text-[#4b4b4b] text-center w-full">
      <div className="flex flex-col font-['Pretendard:Black',sans-serif] justify-center relative shrink-0 text-[48px] w-full">
        <p className="leading-[1.713]">{t('quote.title')}</p>
      </div>
      <div className="flex flex-col font-['Pretendard:Regular',sans-serif] justify-center relative shrink-0 text-[24px] w-full">
